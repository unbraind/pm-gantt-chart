#!/usr/bin/env node
/**
 * Enforce meaningful docstrings across pm-gantt-chart source declarations.
 *
 ...
 * file is executing, so it exists. Swallowing that would leave
 * {@link main} unreached and the process exit code at zero — a mandatory gate
 * reporting success having scanned nothing. It therefore fails closed and
 * throws, because a release script that silently no-ops is worse than one that
 * crashes.
 *
